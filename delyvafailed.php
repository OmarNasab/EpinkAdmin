...
if ($result->num_rows > 0){
	...
	$result = $db->query($sql);
	if ($result->num_rows > 0){
		if($statusCode == "900" || $statusCode == 900){
			$sqlu = "UPDATE chats SET delivery_completed='Ready for pickup', delyva_order_status='$statusCode' WHERE delyva_order_id='$delyva_order_id'";
		}else{
