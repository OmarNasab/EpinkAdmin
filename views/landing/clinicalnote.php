...
if ($result->num_rows > 0) {
	...
	$clincalNote = json_decode($row["clincalNote"]);
}
...
$pdf->Cell(40,10,'Digital Clinical Notes');
$pdf->Ln();
...
$pdf->Ln();
$pdf->Cell(40,10,'Subjective: ');
$pdf->SetFont('Arial','', 7);
$pdf->Cell(40,10,''.$clincalNote->subjective);
$pdf->Ln();
...
$pdf->SetFont('Arial','', 7);
$pdf->Cell(40,10,''.$clincalNote->objective);
$pdf->Ln();

$pdf->SetFont('Arial','B',7);
$pdf->Cell(40,10,'Assessment: ');
$pdf->SetFont('Arial','', 7);
$pdf->Cell(40,10,''.$clincalNote->assessment);
$pdf->Ln();

$pdf->SetFont('Arial','B',7);
$pdf->Cell(40,10,'Plan: ');
$pdf->SetFont('Arial','', 7);
$pdf->Cell(40,10,''.$clincalNote->plan);
$pdf->Ln();
$pdf->SetFont('Arial','B',10);
