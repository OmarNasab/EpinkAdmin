				<!-- Page Header-->
					...
					<section class="bg-white py-10">
                        <div class="container px-5 bg-whit">
							...
							<h3>Home care</h3>
							<p>Services available in home care</p>							
                            <div class="row gx-5" id="searchresult">
										<div class="col-md-6 col-xl-4 mb-5">
											<div class="card card-team">
												<img class="card-img-top" src="https://epink.health/img/ev/doc.png" alt="...">
												<div class="card-body">
												...
												<div class="card-footer text-center d-grid gap-2">
													<a href="https://epink.health/featured/consult-a-doctor/" class="btn epink-btn-primary btn-sm">More information</a>
												</div>
											</div>
										</div>	
										<div class="col-md-6 col-xl-4 mb-5">
											<div class="card card-team">
												<img class="card-img-top" src="https://epink.health/img/ev/pisio.png" alt="...">
												<div class="card-body">
												...
												<div class="card-footer text-center d-grid gap-2">
													<a href="https://epink.health/featured/consult-with-healthcare-personnel/" class="btn epink-btn-primary btn-sm">More information</a>
												</div>
											</div>
										</div>	
										<div class="col-md-6 col-xl-4 mb-5">
											<div class="card card-team">
												<img class="card-img-top" src="https://epink.health/img/ev/phy.png" alt="...">
												<div class="card-body">
					...
					<section class="bg-white py-10">
                        <div class="container px-5 bg-whit">
							...
							<h3>Elderly Care</h3>
							<p>Services available in Elderly care</p>							
                            <div class="row gx-5" id="searchresult">
								<?php
