		...
		<div class="page-header-content">
			<div class="row align-items-center justify-content-between pt-3">
				...
				<div class="col-12 col-xl-auto mb-3">  
					<a class="btn btn-sm btn-light text-primary" href="<?php echo $domain; ?>/pharmacy-panel/orders/purchase-order/all/">All Orders</a>  
                </div>
			</div>
		</div>
	</div>
...
<div class="container-xl px-4">
	<div class="card mb-4">
		<div class="card-header text-black">Latest order</div>
			<div class="card-body">
			 	<table id="myTable">
			 		<thead>
			 			<tr>
			 		...
			 		<tbody>
			 			<?php
							...
							$sql = "SELECT * FROM job_order WHERE restaurant_id='$vendorid' ORDER BY id DESC";
							$result = $db->query($sql);
							if ($result->num_rows > 0) {
