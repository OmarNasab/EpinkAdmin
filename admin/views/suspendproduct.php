 ...
 if(isset($_POST["delete"])){
	...
	$sql = "UPDATE products SET approved='false' WHERE id='$pid'";
  ...
  <div class="card-body">
	...
	?>
		<form method="POST" action="">
			<p>Are you sure about suspending this vendor product?</p>
			<input type="text" id="productid" name="productid" value="<?php echo $page_identifier_action; ?>" hidden>
			<button type="submit" name="delete" id="delete" class="btn btn-danger">Suspend</button>
		</form>
	</section>
	<?php } ?>
</div>