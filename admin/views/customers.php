                                    ...
                                    <?php
                                        ...
                                        if ($result->num_rows > 0) {
                                          ...
                                          while($row = $result->fetch_assoc()) {
											...
											if($row["customer_approved"] == "true"){
												$rev = '';
											}else{
												$rev = 'Verification re-evaluation required';
											}
                                        	echo '
                                                          <tr>
														  <td>'.$noid.'</td>
														   <td><img src="'. $row["ic"].'" width="50%">
                                                            <br>'.$rev.'</td>
                                                            ...
                                                            <td><center><a class="btn btn-primary" href="'.$domain.'/patients/'.$row["id"].'/">Manage</a></center></td>
                                                          </tr>
                                        ';	
										$noid++;
                                          }
