...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Pharmacy Settlements</h1>
                </div>
                <div class="col-sm-6"> 
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">Settle pharmacy earnings</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header"><b>Pharmacy</b> </div>
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                        $sql = "SELECT * FROM users WHERE wallet > 0 AND type != 0 AND verified_service_provider ='Approved' AND provider_type = 'Pharmacist'";
                                        $result = $db->query($sql);                                     
                                        if ($result->num_rows > 0) {
                                          ...
                                          while($row = $result->fetch_assoc()) {
											...
											echo '
                                                <tr>
													<td><span class="font-weight-bold">'. $row["vendor_name"].' </span><p class="text-sm">'. $row["fullname"].'</p></td>
