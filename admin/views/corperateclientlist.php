            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6"> 
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active"><a href="<?php echo $domain; ?>/corporate-client/create/">CREATE</a></li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                        $sql = "SELECT * FROM users WHERE company_manager='true'";
                                        $result = $db->query($sql);
                                        ...
                                        if ($result->num_rows > 0) {
                                          ...
                                          while($row = $result->fetch_assoc()) {
                                        	...
                                        	echo '<tr>
                                                            ...
                                                            <td><a class="btn btn-primary" href="'.$domain.'/corporate-client/edit/'.$row["id"].'/">Edit</a>
															 <a class="btn btn-primary" href="'.$domain.'/corporate-client/delete/'.$row["id"].'/">Delete</a></td>
                                                 </tr>';	
											$noid++;
                                          }
                                        } else {
