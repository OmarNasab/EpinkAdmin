            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6"> 
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active"><a href="<?php echo $domain; ?>/blog/create/" class="btn btn-primary">POST BLOG</a></li>
                    </ol>
                </div>
            </div>
        </div>
                                          ...
                                          while($row = $result->fetch_assoc()) {                                        	
                                        	echo '
														  ...
														  <td>'.$row["publishing_date"].'</td>
                                                            ...
                                                            <td><center><a class="btn btn-primary" href="'.$domain.'/blog/delete/'.$row["id"].'/">Delete</a></center></td>
                                                          </tr>
                                        ';	
										$noid++;
                                          }
