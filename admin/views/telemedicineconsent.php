...
if(isset($_POST["update_pnc"])){
	...
	$sql1 = "UPDATE settings SET setting_value='$setting_value' WHERE setting_item='telemed'";
...
$uid = $authuser["id"];
$sqlsetting = "SELECT * FROM settings WHERE setting_item='telemed'";
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6"> 
                    <h1>Tele Medicine Consent</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">Telemedice consent editor</li>
                    </ol>
                </div>
            </div>
        </div>
