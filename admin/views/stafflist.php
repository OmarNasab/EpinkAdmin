            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active"><a href="<?php echo $domain; ?>/staffs/create/" class="btn btn-primary">Create</a></li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                        $sql = "SELECT * FROM users WHERE type=8 OR type=7";
                                        $result = $db->query($sql);
                                          ...
                                          while($row = $result->fetch_assoc()) {
                                        	...
                                        	echo '
                                                          <tr>
                                                            ...
                                                            <td> '. $type.'</td>
                                                            <td><center><a class="btn btn-primary" href="'.$domain.'/staff-delete/'.$row["id"].'/">DELETE</a></center></td>
                                                          </tr>
                                        ';	
                                          }
                                        } else {
