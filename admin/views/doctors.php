                    ...
                    <div class="card">
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                        $sql = "SELECT * FROM users WHERE verified_service_provider='Approved' AND type=6";
                                        $result = $db->query($sql);
                                          ...
                                          while($row = $result->fetch_assoc()) {
                                        	...
                                        	echo '
														  ...
														  <td>'. $row["provider_type"].'
                                                            ...
                                                            <td><center><a class="btn btn-primary" href="'.$domain.'/healthcare-personel/'.$row["id"].'/">Manage</a></center></td>
                                                          </tr>
                                        ';	
										$noid++;
                                          }
