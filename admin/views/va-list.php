                                          ...
                                          while($row = $result->fetch_assoc()) {                                        	
                                        	echo '
														  ...
														  <td>'.$row["fullname"].'</td>
                                                            ...
                                                            <td><a class="btn btn-primary" href="https://epink.health/admin/volunteer-application/view/'.$row["id"].'/">View</a> <a class="btn btn-primary" href="'.$domain.'/volunteer-application/delete/'.$row["id"].'/">Delete</a></td>
                                                          </tr>
                                        ';	
										$noid++;
                                          }
