...
<div class="content-wrapper">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">Master category manager</li>
                    </ol>
                </div>
            </div>
        </div>
	...
	<div class="card mb-4">
		<div class="card-header text-black">Category</div>
			<div class="card-body">
				<p>This master category only applicable for new pharmacy account.</p>
...
<script>
                ...
                function initCategorylist(){
                	...
                	for (i = 0; i < listofcategories.length; i++) {
					  ...
					  for (j = 0; j < subcategory.length; j++){
						  subto += '<span class="badge bg-secondary">'+subcategory[j].name+'<a href="#!" onclick="removesubCategory('+i+', '+j+')" class="pull-right" data-toggle="modal" data-target="#deleteSubMobdal"> <i class="fas fa-times text-light"></i></a></span> ';
					  }
					  //document.getElementById("listofcategory").innerHTML += '<div class="card"><div class="card-body"></div></div>';
                	  document.getElementById("listofcategory").innerHTML += '<div class="col-sm-6 col-lx-6 mb-3"><div class="card"><div class="card-body">'+listofcategories[i].name+' <span class="float-right"><a href="#!" onclick="removeCategory('+i+', \''+listofcategories[i].name+'\')" class="pull-right" data-toggle="modal" data-target="#removemaincategory"><i class="fas fa-times"></i></a></span><br><a href="#!" onclick="addSubt('+i+')" data-bs-toggle="modal" data-toggle="modal" data-target="#exampleModal">Add Sub Category</a><br>'+subto+'</div></div></div>';
                	}
                } 
				...
				function updateLabcategory(){
						...
						var dataTopost = 'api=1&auth_token='+authUser.login_token+"&adminupdatemastercategory="+settingValue+"&pid="+pharmaid;
