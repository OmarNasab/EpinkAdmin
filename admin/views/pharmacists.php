                    ...
                    <div class="card">
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                        $sql = "SELECT * FROM users WHERE provider_type='Pharmacist' AND verified_service_provider='Approved'";
                                        $result = $db->query($sql);
                                          ...
                                          while($row = $result->fetch_assoc()) {
                                        	...
                                        	echo '
                                                          <tr>
                                                            ...
                                                            <td><center><a class="btn btn-primary" href="'.$domain.'/pharmacist-manager/'.$row["id"].'/">Manage</a> <a class="btn btn-primary" href="'.$domain.'/pharmacists/category-manager/'.$row["id"].'/">Category Manager</a> <a class="btn btn-primary" href="'.$domain.'/pharmacists/products/'.$row["id"].'/">Product Manager</a></center></td>
                                                          </tr>
                                        ';	
										$noid++;
                                          }
