...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Flood Relief Healthcare Program</h1>
                </div>
                <div class="col-sm-6"> 
                                          ...
                                          while($row = $result->fetch_assoc()) {
                                        	...
                                        	echo '
														  ...
														  <td>'.$noid.'</td>
                                                            ...
                                                            <td><center><a class="btn btn-primary" href="'.$domain.'/flood-victim-health-care/view/'.$row["id"].'/">View</a></center></td>
                                                          </tr>
                                        ';	
										$noid++;
                                          }
