                    ...
                    <div class="card">
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                        $sql = "SELECT * FROM users WHERE wallet > 0 AND type != 0 OR wallet > 0 AND type != 8";
                                        $result = $db->query($sql);
                                        ...
                                        if ($result->num_rows > 0) {
                                          ...
                                          while($row = $result->fetch_assoc()) {
                                        	if($row["bank_name"] == ""){
												$row["bank_name"] = "Bank name not set";
											}
											if($row["bank_account_number"] == ""){
												$row["bank_account_number"] = "Account number not set";
											}
                                        	echo '
                                                          <tr>
														  <td>'.$noid.'</td>
                                                            ...
                                                            <td><a class="btn btn-primary" href="'.$domain.'/finance/set-paid/'.$row["id"].'/">Set as paid</a></td>
                                                          </tr>
                                        ';	
										$noid++;
                                          }
