            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6"> 
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">List of new E-lab request</li>
                    </ol>
                </div>
            </div>
        </div>
                                          ...
                                          while($row = $result->fetch_assoc()) {
                                        	...
                                        	echo '
                                                          <tr>
                                                            ...
                                                            <td>'. $usersdata["firstname"].' '. $usersdata["lastname"].'<br>'. $row["request_address"].'</td>
															<td>'. $row["request_status"].'</td>
                                                            <td><center><a class="btn btn-primary" href="'.$domain.'/elab-requests/update/'.$row["id"].'/">View</a> <a class="btn btn-primary" href="'.$domain.'/elab-requests/delete/'.$row["id"].'/">Delete</a></center></td>
                                                          </tr>
                                        ';	
										$noid++;
                                          }
