...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Covid 19 Vaccination Consent</h1>
                </div>
                <div class="col-sm-6"> 
                                          ...
                                          while($row = $result->fetch_assoc()) {
                                        	...
                                        	echo '
														  ...
														  <td>'.$noid.'</td>
                                                            ...
                                                            <td>'. $row["icpassport"].'</td>
                                                            <td>'. $row["mysejahteraid"].'</td>
                                                     
                                                            <td><center><a class="btn btn-primary" href="https://epink.health/covid-19-vaccination-consent/pdf/'.$row["icpassport"].'/">PDF</a></center></td>
                                                          </tr>
                                        ';	
										$noid++;
                                          }
