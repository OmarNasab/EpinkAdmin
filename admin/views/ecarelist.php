            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6"> 
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active"><a href="<?php echo $domain; ?>/ecare-manager/create/">CREATE</a></li>
						<li class="breadcrumb-item active"><a href="<?php echo $domain; ?>/ecare-manager/category-manager/">CATEGORY MANAGER</a></li>
                    </ol>
                </div>
            </div>
        </div>
                                          ...
                                          while($row = $result->fetch_assoc()) {
                                        	...
                                        	echo '
														  ...
														  <td>'.$noid.'</td>
                                                            ...
                                                            <td><a class="btn btn-primary" href="'.$domain.'/ecare-manager/edit/'.$row["id"].'/">Edit</a>
															 <a class="btn btn-primary" href="'.$domain.'/ecare-manager/delete/'.$row["id"].'/">Delete</a></td>
                                                          </tr>
                                        ';	
										$noid++;
                                          }
