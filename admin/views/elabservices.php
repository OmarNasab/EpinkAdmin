            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6"> 
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active"><a href="<?php echo $domain; ?>/elab/create/">CREATE SERVICE</a></li>
                        <li class="breadcrumb-item active"><a href="<?php echo $domain; ?>/elab/category-manager/">CATEGORY MANAGER</a></li>
                    </ol>
                </div>
            </div>
        </div>
                                          ...
                                          while($row = $result->fetch_assoc()) {
                                        	...
                                        	echo '
														  ...
														  <td>'.$noid.'</td>
                                                            ...
                                                            <td><center> <a class="btn btn-primary" href="'.$domain.'/elab/edit/'.$row["id"].'/">Edit</a> <a class="btn btn-primary" href="'.$domain.'/elab/delete/'.$row["id"].'/">Delete</a></center></td>
                                                          </tr>
                                        ';	
										$noid++;
                                          }
