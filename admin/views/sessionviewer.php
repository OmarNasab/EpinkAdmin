...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Tele Consultation Detail</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active"><a href="<?php echo $domain; ?>/sessions/">Back</a></li>
                    </ol>
                </div>
            </div>
        </div>
...
?>">
	<div class="card-header"><span class="text-black"><b>Prescribed Medication</b></span></div>
	<div class="card-body">
	<?php
