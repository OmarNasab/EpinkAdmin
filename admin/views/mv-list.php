...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Outreach Vaccination</h1>
                </div>
                <div class="col-sm-6"> 
                    <a href="<?php echo $domain; ?>/mobile-vaccination/full/" class="float-left">View Full</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
                                          ...
                                          while($row = $result->fetch_assoc()) {                                        	
                                        	echo '
														  ...
														  <td>'.$row["full_name"].'</td>
                                                            ...
                                                            <td>'. $row["ic_passport_no"].'
                                                            </td>                                                    <td>'. $row["gender"].'
                                                            </td>                    
                                                            <td><a class="btn btn-primary" href="https://epink.health/admin/mobile-vaccination/view/'.$row["id"].'/">View</a> <a class="btn btn-primary" href="'.$domain.'/mobile-vaccination/delete/'.$row["id"].'/">Delete</a></td>
                                                          </tr>
                                        ';	
										$noid++;
                                          }
