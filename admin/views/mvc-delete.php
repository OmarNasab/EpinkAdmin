...
$sql = "DELETE FROM outreach_corporate WHERE id='$codeid'";

if ($db->query($sql) === TRUE) {
   $response = "This service has been deleted. <a href='".$domain."/mobile-vaccination-corporate/'>Back to outreach management</a>";
} else {
