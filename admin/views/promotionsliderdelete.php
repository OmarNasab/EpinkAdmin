...
$sql = "DELETE FROM news WHERE id='$codeid'";

if ($db->query($sql) === TRUE) {
   $response = "This code has been deleted. <a href='".$domain."/promotions/'>Back to promotion slider list</a>";
} else {
