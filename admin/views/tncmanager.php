...
if(isset($_POST["update_pnc"])){
	...
	$sql1 = "UPDATE settings SET setting_value='$setting_value' WHERE setting_item='tnc'";
...
$uid = $authuser["id"];
$sqlsetting = "SELECT * FROM settings WHERE setting_item='tnc'";
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">Term and condition editor</li>
                    </ol>
                </div>
            </div>
        </div>
