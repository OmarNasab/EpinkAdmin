...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Patients Sessions</h1>
                </div>
                <div class="col-sm-6"> 
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">Completed session between doctor & patient</li>
                    </ol>
                </div>
            </div>
        </div>
				...
				$sessionstatus = 'Session Ended';
                                        	...
                                        	echo '
														  ...
														  <td>'.$row["id"].'</td>
                                                            ...
                                                            <td><a href="'.$domain.'/healthcare-personel/'.$doctorid.'/">'. $doctor["fullname"].'</a></td>
															<td>'. $sessionstatus.'</td>
										  <td><a href="/admin/sessions/view/'.$row["id"].'/">VIEW</a> | <a href="/admin/sessions/archive/'.$row["id"].'/">ARCHIVE</a> | <a href="/admin/sessions/delete/'.$row["id"].'/">DELETE</a></td>
