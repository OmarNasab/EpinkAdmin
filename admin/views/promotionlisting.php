            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active"><a href="<?php echo $domain; ?>/promotions/create/" class="btn btn-primary">Create</a></li>
                    </ol>
                </div>
            </div>
        </div>
                                          ...
                                          while($row = $result->fetch_assoc()) {
                                        	...
                                        	echo '
                                                          <tr>
                                                            ...
                                                            <td>'. $row["title"].'</td>
															<td>'. $row["newsdate"].'</td>
															<td><center><a class="btn btn-primary" href="'.$domain.'/promotions/delete/'.$row["id"].'/">DELETE</a></center></td>
                                                          </tr>
                                        ';	
                                          }
                                        } else {
