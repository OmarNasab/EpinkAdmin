                    ...
                    <div class="card">
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                        $sql = "SELECT * FROM rider_activations WHERE status='Waiting' ORDER by id DESC";
                                        $result = $db->query($sql);
                                          ...
                                          while($row = $result->fetch_assoc()) {
                                        	...
                                        	echo '
                                                          ...
                                                          \
                                                            ...
                                                            <td><img src="'. $row["rider_ic"].'"  class="img-fluid"></td>
                                                            <td> <img src="'. $row["rider_lisence"].'"  class="img-fluid"></td>
															<td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal" onclick="prepareThis(\''. $usersdata["id"].'\', \''. $row["id"].'\', \'On\')">
																ACTION
																</button>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div id="view" class="modal-body">
				Approve this rider verification request?
				<br>
				<br>
...
function approve(action){
	var dataTopost = "api=1&auth_token=" + authUser.login_token + "&approveuser="+userid+"&applicationid="+applicationid+"&reviewresult="+action;
